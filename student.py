...
class Student :
    def __init__(self,root) :
        ...
        bgimg = bgimg.resize((1545,665),Image.LANCZOS)
        self.photoimg = ImageTk.PhotoImage(bgimg)
        bg_img = Label(self.root,image=self.photoimg)
        bg_img.place(x=0,y=130,width=1545,height=665)
        ...
        Left_frame = LabelFrame(main_frame,bd=2,relief=RIDGE,text="Student Form",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=730,height=580)
        
        img_left = Image.open("D:/Student Attendence System/images/si2.png")
        img_left = img_left.resize((715,130),Image.LANCZOS)
        ...
        current_course_frame.place(x=5,y=135,width=715,height=100)
        ...
        course_combo["values"]=("Select Course","Engineering","Medicine","Art","Business","Finance")
        course_combo.current(0)
        course_combo.grid(row=0,column=1,padx=2,pady=5)
        ...
        dep_combo["values"]=("Select Department","IT","Computer","Civil","Mechanical","Electrical","EC","Medicine","Art","Business","Finance")
        dep_combo.current(0)
        dep_combo.grid(row=0,column=3,padx=2,pady=5)
        ...
        class_student_frame.place(x=5,y=240,width=715,height=310)
        ...
        class_combo = ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman",12,"bold"),state="readonly",width=18)
        class_combo["values"]=("Select","A","B")
        ...
        btn_frame1.place(x=5,y=220,width=700,height=30)
        
        save_btn = Button(btn_frame1,text="Save",command=self.add_data,font=("times new roman",12,"bold"),width=15,bg="#d9d9d9",fg="black")
        save_btn.grid(row=0,column=0,padx=18)
        
        update_btn = Button(btn_frame1,text="Update",command=self.update_data,font=("times new roman",12,"bold"),width=15,bg="#d9d9d9",fg="black")
        update_btn.grid(row=0,column=1,padx=12)
        
        delete_btn = Button(btn_frame1,text="Delete",command=self.delete_data,font=("times new roman",12,"bold"),width=15,bg="#d9d9d9",fg="black")
        ...
        btn_frame2 = Frame(class_student_frame,relief=RIDGE)
        btn_frame2.place(x=5,y=255,width=700,height=30)
        
        take_photo_btn = Button(btn_frame2,text="Take Photo",command=self.generate_dataset,font=("times new roman",12,"bold"),width=30,bg="#d9d9d9",fg="black")
        take_photo_btn.grid(row=0,column=0,padx=37)
        
        update_photo_btn = Button(btn_frame2,text="Update Photo",font=("times new roman",12,"bold"),width=30,bg="#d9d9d9",fg="black")
        update_photo_btn.grid(row=0,column=1,padx=27)
        
        Right_frame = LabelFrame(main_frame,bd=2,relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Right_frame.place(x=750,y=10,width=720,height=580)
        
        img_right = Image.open("D:/Student Attendence System/images/si1.png")
        img_right = img_right.resize((705,130),Image.LANCZOS)
        ...
        search_frame.place(x=5,y=135,width=705,height=60)
        ...
        search_btn = Button(search_frame,text="Search",font=("times new roman",12,"bold"),width=10,bg="#d9d9d9",fg="black")
        search_btn.grid(row=0,column=3,padx=10)
        
        showAll_btn = Button(search_frame,text="Show All",font=("times new roman",12,"bold"),width=10,bg="#d9d9d9",fg="black")
        showAll_btn.grid(row=0,column=4,padx=10)
        
        table_frame = Frame(Right_frame,bd=2,relief=RIDGE)
        table_frame.place(x=5,y=200,width=705,height=350)
    ...
    def add_data(self):
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_sem.get()=="Select Semester" or self.var_id.get()=="" or self.var_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_phone.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="") :
        ...
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_sem.get()=="Select Semester" or self.var_id.get()=="" or self.var_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_phone.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="") :
            ...
            try:
                ...
                if Update>0:
                    conn = mysql.connector.connect(host="localhost",user="root",password="",database="face_recognition")
                    my_cursor = conn.cursor()
                    my_cursor.execute("UPDATE student SET Course=%s,Department=%s,Year=%s,Semester=%s,Name=%s,Division=%s,RollNo=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,Photo=%s WHERE Id=%s",(
                        self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
                        self.var_sem.get(),
    ...
    def generate_dataset(self):
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_sem.get()=="Select Semester" or self.var_id.get()=="" or self.var_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_phone.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="" or self.var_radio.get()=="") :
            messagebox.showerror("Error","All Fields are required",parent=self.root)
        else:
            try:
                conn = mysql.connector.connect(host="localhost",user="root",password="",database="face_recognition")
                ...
                while True:
                    ...
                    if ret and face_cropped(myframe) is not None:
                        img_id+=1
